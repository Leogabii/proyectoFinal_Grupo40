...
//        int idMesa = pedido.getMesa().getIdMesa();
    ...
    public List<Pedido> listarPedidosPorIdMesero(String nombreMesero) {
        ArrayList<Pedido> pedidos = new ArrayList<>();
        String sql = "select id_pedido, id_mesa, nombre_mesero, fecha_hora, importe, cobrada from pedido where nombre_mesero = ?";
        try {
    ...
    public List<Pedido> listarPedidosDeMeseroPorFecha(String nombreMesero, LocalDate fecha) {
        ArrayList<Pedido> pedidos = new ArrayList<>();
        String sql = "select id_pedido, id_mesa, nombre_mesero, fecha_hora, importe, cobrada from pedido where nombre_mesero = ? and fecha_hora = ?%";
        try {
            PreparedStatement ps = con.prepareStatement(sql);
            ps.setString(1, nombreMesero);
